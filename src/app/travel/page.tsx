...
const subSections = [
  { label: "颐和园", desc: "哪个季节去最好、哪个角落没人", href: "/travel/summer-palace" },
  { label: "胡同漫步", desc: "我最喜欢逛的几条胡同，不是南锣鼓巷", href: "/travel/hutong" },
  { label: "798艺术区", desc: "一个社会学学生怎么看798", href: "/travel/798" },
  { label: "小众好去处", desc: "只有我知道的北京秘密角落", href: "/travel/hidden-gems" },
  { label: "周边两日游", desc: "周末逃离北京的好路线", href: "/travel/weekend-trips" },
];
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#161412", color: "#e6ddd2" }}>
      <div style={{ padding: "120px 24px 64px", maxWidth: 1100, margin: "0 auto" }}>
        ...
        >
          我的个人推荐，不是旅游网站的百科。每个地方都亲自去过，每个评价都发自真心。
        </motion.p>
      </div>
